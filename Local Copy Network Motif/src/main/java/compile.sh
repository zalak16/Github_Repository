...
javac -cp `hadoop classpath`:. labelg.exe edu/uw/nemo/nauty/*.java edu/uw/nemo/labeler/*.java edu/uw/nemo/ESUGen.java edu/uw/nemo/motifSignificant/explicitMethod/*.java edu/uw/nemo/motifSignificant/explicitMethod/SwitchingAlgorithm/*.java edu/uw/nemo/motifSignificant/mapreduce/*.java  edu/uw/nemo/model/*.java edu/uw/nemo/io/*.java 
...
jar -cvf nemo.jar labelg.exe edu/uw/nemo/nauty/*.class edu/uw/nemo/labeler/*.class edu/uw/nemo/ESUGen.class edu/uw/nemo/motifSignificant/explicitMethod/*.class edu/uw/nemo/motifSignificant/explicitMethod/SwitchingAlgorithm/*.class edu/uw/nemo/motifSignificant/mapreduce/*.class  edu/uw/nemo/model/*.class edu/uw/nemo/io/*.class 
